...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, _______, KC_BSLS,
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, KC_HOME, KC_END,  _______, KC_DEL,  _______, _______, _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  RGB_M_P, _______, RGB_VAD, RGB_SAD, RGB_HUD, _______, _______, RGB_RMOD,_______, _______, _______, KC_PIPE,
